...
<body>
	<center>
		<h1>CV. Global Karunia Technology</h1>
	...
	<table class="table table-bordered table-triped">
		...
		foreach ($cetak_gaji as $g) : ?>
			<tr>
				...
				<td class="text-center">Rp. <?php echo number_format($g->jml_potongan, 0, ',', '.') ?></td>
				<td class="text-center">Rp. <?php echo number_format($g->total_gaji, 0, ',', '.') ?></td>
			</tr>
		<?php endforeach; ?>
	</table>
	...
	<table width="100%">
		<tr>
			<td></td>
			<td width="200px">
				<p>Semarang, <?php echo date("d M Y") ?> <br> Direktur</p>
				<br>
				<br>
